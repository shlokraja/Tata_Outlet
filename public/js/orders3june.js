function populateOrders(time) {
  ...
  .done(function(data) {
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      var mobile_num = data[i].mobile_num;
...
function checkIfAlreadyRefunded(sourceBarcode) {
  var goodItems = 0;
  var badItems = 0;
...
$("#orders").on("click", "#refund", function() {
  ...
  $("#orders .bill_item_checkbox:checked").each(function(index) {
    ...
    if (checkIfAlreadyRefunded(barcode)) {
      return false;
    }
    total_price += price;
...
$("#orders").on("click", "#replace", function() {
  ...
  $("#orders .bill_item_checkbox:checked").each(function(index) {
    ...
    if (checkIfAlreadyRefunded($(this).attr("data-barcode")) || price < 0) {
      return false;
    }
    total_items++;
